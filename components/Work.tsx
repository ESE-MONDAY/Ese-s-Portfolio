  ...
  return (
    <div id='triggerElement' className='mt-16 md:m-20 lg:m-40 flex flex-col lg:flex-row sm;px-16 justify-between'>
      <div className='basis-1/3 flex sm:flex-col sm:gap-0 gap-3'>
        <p className='text-3xl sm:text-6xl sm:mt-8  font-gallient  font-semibold text-start lg:ml-40 '>Resume</p>
        <p className='text-3xl sm:text-6xl sm:mt-4  font-gallient  font-semibold text-start lg:ml-48  '>Experience</p>
        </div>
